...
VULCAN is a web-based interactive visualization tool designed to support research on galaxy clusters using spectral cube data from the James Webb Space Telescope's Medium Resolution Spectrometer (MRS). It focuses on exploring spaxels and gas dynamics using Abell 2597 (A2597) as a proxy target.
